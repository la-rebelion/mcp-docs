...
title: HAPI MCP Architecture
description: 'An overview of the HAPI MCP architecture, including HAPI Server, runMCP, and how they work together to enable API-first, OpenAPI-driven systems.'
keywords:
  - HAPI MCP
...
<InlineSVG name="hapi-mcp-diagram" 
  alt="HAPI MCP Architecture Diagram"
  width="80%"
...
<div className="center-image">
  <img src={require('@site/static/img/diagrams/runMCP-flow.svg').default} 
    alt="runMCP Flow Diagram" 
    width="80%" 
  />
</div>
