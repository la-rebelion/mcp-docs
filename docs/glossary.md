...
## **M**
### **MCP (Model Context Protocol)**: "*A standardized way to connect AI models to different data sources and tools*" (as per official [specs](https://modelcontextprotocol.io/docs/getting-started/intro)). We see this as a *contract* that defines how interfaces should behave in AI-native systems, enabling more effective interactions between users and models.
